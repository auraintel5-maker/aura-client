...
const AdCreativesCta = () => {
  ...
  return (
    <section className="relative bg-[#FAF9F6] text-[#0F1E3C] py-32 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6">
        <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#008B8B] to-[#E5E5E5]">
            One Image.
          </span>
        </h2>

        <p className="text-lg text-[#000000]/80 mb-10 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            className="bg-gradient-to-r from-[#008B8B] to-[#E5E5E5] text-black px-4 py-6 text-base hover:scale-105 transition-transform duration-300"
            onClick={() => navigate("/packages-billing?mode=starter_pack")}
          >
            Upload Image
          </Button>
          <Button
            className="border border-[#E5E5E5]/40 text-[#E5E5E5] px-4 py-6 text-base hover:bg-[#0F1E3C] transition-colors duration-300"
