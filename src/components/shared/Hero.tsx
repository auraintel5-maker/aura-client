  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full h-full">
        ...
        >
          <motion.h1
            className="text-[#2F2F2F] text-4xl md:text-6xl font-extrabold tracking-tight mb-6"
          ...
          <motion.p
            className="text-[#008B8B] mb-8 text-center w-[100%] md:w-[90%] text-lg font-semibold"
          ...
          >
            <Button
              className="bg-[#0F1E3C] text-[#FAF9F6] hover:text-[#FAF9F6] hover:bg-[#0F1E3C] text-lg px-4 py-5 transform transition duration-300 hover:scale-95 border border-black font-semibold"
