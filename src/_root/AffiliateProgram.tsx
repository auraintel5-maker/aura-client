...
const AffiliateProgram = () => {
  return (
    <>
      <WebLayoutWrapper>
        <div className="bg-[#FAF9F6] min-h-screen flex flex-col items-center justify-center px-6 text-center">
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-[#008B8B]">Affiliate Program</h1>

            <p className="mt-4 text-lg text-[#0F1E3C]">
