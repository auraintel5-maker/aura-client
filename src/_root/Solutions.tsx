      ...
      <section className="bg-white text-black py-24 px-6 md:px-16">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
            ...
            <br />
            <span className="text-[#008B8B]">High-Performing Campaigns</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          ...
          >
            <img
              src="https://res.cloudinary.com/dibavvbpi/image/upload/v1764356918/GeneratedImageNovember122025-9_19PM_enlbuk.png"
              alt="Raw Phone Image"
        ...
        <div className="mb-24">
          ...
          {/* Video Placeholder */}
          <motion.video
            src="https://res.cloudinary.com/dibavvbpi/video/upload/v1764356827/Opening_shot__202511171606_a8zg3q.mp4"
            autoPlay
            muted
            loop
            playsInline
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 1 }}
            className="text-[#008B8B] text-xl font-semibold"
          >
