...
const PackagesBillings = () => {
  ...
  return (
    <section className="bg-[#FAF9F6] min-h-screen text-[#0F1E3C] py-10 md:py-20 px-6 md:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h2 className="text-4xl font-extrabold mb-3">
            Complete Your <span className="text-[#008B8B]">Order</span>
          </h2>
        ...
        {/* ======================= ORDER SUMMARY ======================= */}
        <div className="bg-white border border-white/10 rounded-2xl p-8 h-fit sticky top-10 shadow-2xl">
          <h3 className="text-2xl font-bold mb-6">Order Summary</h3>

          <div className="space-y-3 mb-6">
            <p className="text-[#0F1E3C] text-lg font-semibold">{pkg.name}</p>
            <p className="text-4xl font-extrabold text-[#008B8B]">
              {pkg?.price.toLocaleString()}
            </p>
          </div>

          <div className="border-t border-[#008B8B] my-6" />

          <h4 className="text-[#0F1E3C] text-sm mb-3">What’s Included</h4>
          <ul className="space-y-2 text-[#0F1E3C] text-sm">
          ...
          <p className="text-xs text-[#0F1E3C]">
