            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl p-8 border ${
                  pkg.highlight
                    ? "border-[#FCA311] bg-gradient-to-b from-[#0F1E3C]/40 to-[#000] shadow-xl scale-105"
              ...
              >
                ...
                <Button
                  className="w-full bg-[#008B8B] text-black hover:bg-[#E5E5E5] py-5 text-base font-semibold"
                  onClick={() => {
                    if (isPro) {
                      navigate("/contact");
                    } else {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-4 rounded-lg border border-white/10 bg-[#0F1E3C] text-[#FAF9F6]"
              >
                {item}
              </motion.div>
            ))}
